...
namespace WebAppCine2.BackEnd
{
    public class clsadministrador
    {
        ...
        public string guardar()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SP_Administrador_Guardar", conn);
            try
            {
                ...
                //creamos los parametros
                MySqlParameter Psexo = new MySqlParameter("Sexo", MySqlDbType.VarChar, 1);
                //asignamos el valor al parametro
                Psexo.Value = genero;
                //agregamos el parametro al comando
                ...
                {
                    return "Ocurrio un error al registrar el Administrador";
                }
            }
            //capturar el error
            catch (Exception e)
            {
                ...
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Admin_Guardar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {
            MySqlCommand cmd = new MySqlCommand("SP_Administrador_Seleccionar", conn);
            try
            {
                cmd.CommandType = CommandType.StoredProcedure;
                MySqlDataReader Dr;
            ...
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Admin_Seleccionar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {
            //creamos un comando para almacenar el procedimiento almacenado
            MySqlCommand cmd = new MySqlCommand("SP_Administrador_Actualizar", conn);
            try
            {
                //le damos un tipo al comando
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    return "Ocurrio un error al Actualizar el Administrador";
                }
            }
            //capturar el error
            catch (Exception e)
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Admin_Actualizar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {//creamos un comando para almacenar el procedimiento almacenado
            MySqlCommand cmd = new MySqlCommand("SP_Administrador_Eliminar", conn);
            try
            {
                //le damos un tipo al comando
                cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Admin_Eliminar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {
            MySqlCommand cmd = new MySqlCommand("SP_Administrador_Buscar", conn);
            try
            {
                cmd.CommandType = CommandType.StoredProcedure;
                MySqlDataReader Dr;
            ...
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Admin_Buscar  " + e.Message);
            }
            finally
            {
                //cierro la conexion
