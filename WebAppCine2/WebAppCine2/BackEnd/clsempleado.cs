...
namespace WebAppCine2.BackEnd
{
    public class clsempleaado
    {
        ...
        public string guardar()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("SP_Empleado_Guardar", conn);
            try
            {
                ...
                //creamos los parametros
                MySqlParameter Psueldo = new MySqlParameter("Sueldo", MySqlDbType.Int32);
                //asignamos el valor al parametro
                Psueldo.Value = sueldo;
                //agregamos el parametro al comando
                cmd.Parameters.Add(Psueldo);
                //creamos los parametros
                ...
                {
                    return "Ocurrio un error al registrar el Empleado";
                }
            }
            //capturar el error
            catch (Exception e)
            {
                ...
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Empleado_Guardar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {
            MySqlCommand cmd = new MySqlCommand("SP_Empleado_Seleccionar", conn);
            try
            {
                cmd.CommandType = CommandType.StoredProcedure;
                MySqlDataReader Dr;
            ...
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Empleado_Seleccionar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {
            //creamos un comando para almacenar el procedimiento almacenado
            MySqlCommand cmd = new MySqlCommand("SP_Empleado_Actualizar", conn);
            try
            {
                //le damos un tipo al comando
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    return "Ocurrio un error al Actualizar el Vendedor";
                }
            }
            //capturar el error
            catch (Exception e)
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Empleado_Actualizar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {//creamos un comando para almacenar el procedimiento almacenado
            MySqlCommand cmd = new MySqlCommand("SP_Empleado_Eliminar", conn);
            try
            {
                //le damos un tipo al comando
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                {
                    return "Ocurrio un error al Eliminar el Vendedor";
                }
            }
            //capturar el error
            catch (Exception e)
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Empleado_Eliminar " + e.Message);
            }
            finally
            {
                //cierro la conexion
        ...
        {
            MySqlCommand cmd = new MySqlCommand("SP_Empleado_Buscar", conn);
            try
            {
                cmd.CommandType = CommandType.StoredProcedure;
                MySqlDataReader Dr;
            ...
            {
                //muestra el error al usuario
                throw new Exception("Hubo un error al ejecutar el procedimiento SP_Empleado_Buscar " + e.Message);
            }
            finally
            {
                //cierro la conexion
